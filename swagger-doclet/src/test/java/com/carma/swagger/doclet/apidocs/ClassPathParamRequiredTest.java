...
public class ClassPathParamRequiredTest {
	...
	public void testStart() throws IOException {
		final RootDoc rootDoc = RootDocLoader.fromPath("src/test/resources", "fixtures" +
			".classpathparamrequired");
		new JaxRsAnnotationParser(this.options, rootDoc).run();

		final ApiDeclaration api = loadFixture
			("/fixtures/classpathparamrequired/classpathparamrequired.json", ApiDeclaration.class);
